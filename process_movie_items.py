...
from scrapy_douban.settings import MONGO_URI, MONGO_DATABASE, REDIS_PASS


logger = logging.getLogger('process_items')


def process_items(r, db, keys, timeout, limit=0, log_every=1000, wait=.1):
